...
<script lang="ts">
  ...
  import type { BasicColumn } from '../../types/table.ts';
  import type { EditRecordRow } from './index.ts';
  ...
  import clickOutside from '../../../../../../../../MFS-XANGYA3/xy3-mfs-web/src/directives/clickOutside.ts';

  import { propTypes } from '../../../../../../../../MFS-XANGYA3/xy3-mfs-web/src/utils/propTypes.ts';
  import { isString, isBoolean, isFunction, isNumber, isArray } from '../../../../../../../../MFS-XANGYA3/xy3-mfs-web/src/utils/is';
  import { createPlaceholderMessage } from './helper.ts';
  import { set, omit } from 'lodash-es';
  import { EventEnum } from '@/components/BasicTable/src/componentMap.ts';
